...
/**
 * Plugin Name: WooCommerce UniversalPay
 * Description: WooCommerce UniversalPay gateway integration.
 * Version: 1.2.1
 */
...
function mmb_gateway_action_links( $links ) {
    $plugin_links = array(
        '<a href="' . admin_url( 'admin.php?page=wc-settings&tab=checkout&section=universalpay' ) . '">' . __( 'Settings', 'universalpay' ) . '</a>',
    );
