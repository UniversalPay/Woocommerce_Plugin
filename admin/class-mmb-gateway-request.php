...
//             customerAddressPhone($post_data['customerAddressPhone'])->
        ...
        switch($this->gateway->api_payment_modes){
            ...
            case '0':
                ...
                $mmb_form[] = '" method="get"><input type="hidden" name="wcapi" value="universalpay"/><input type="hidden" name="order_id" value="'.$order->get_id().'"/><input type="hidden" id="merchantTxId" name="merchantTxId" value=""/></form>';
